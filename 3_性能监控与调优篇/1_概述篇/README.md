...
<img src="https://tvax2.sinaimg.cn/large/006JhGcily1gys6ta57qgj30du0axjum.jpg" alt="image-20210206094124399" width="70%">
...
在 GC 中:运行用户代码的时间占总运行时间的比例（总运行时间:程序的运行时间＋内存回收的时间)吞吐量为 1 -1/(1+n)。-XX:GCTimeRatio=n
